...
const Upload = () => {
 ...
 const imageFile = await convertPdfToImage(file);
        ...
        if(!uploadedImage)  return setStatusText("Error: Failed to upload the image. Please try again.");
  ...
  return (
    ...
    <section className="main-section">
       ...
       {processing ? (
        ...
        <h2>Drop your resume for an ATS score and improvement suggestions tips</h2>
       )}
