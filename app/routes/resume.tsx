...
export const meta = ()=> ([
   ...
   {name:"description", content:"Detailed overview of your resume analysis and feedback"}
])
  ...
  return (
    <main className="pt-0! ">
      <nav className='resume-nav'>
        <Link to="/" className='back-button shadow-md hover:shadow-amber-800'>
      ...
      <div className='flex flex-row w-full max-lg:flex-col-reverse'>
       <section className="feedback-section bg-[url('/images/bg-small.svg')] bg-cover h-screen sticky top-0 items-center justify-center">
                ...
                <section className="feedback-section bg-[url('/images/bg-feedback.jpg')] bg-cover ">
